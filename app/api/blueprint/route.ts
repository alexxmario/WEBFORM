  ...
  try {
    ...
    const { data: blueprint, error } = await supabase
      ...
      .insert({
        ...
        home_copy: data.content.homeCopy,
        domain_status: data.technical.domainStatus,
        integrations: data.technical.integrations,
        current_site: data.technical.currentSite,
        timeline_confirmed: data.confirmations.timeline,
        cancellation_confirmed: data.confirmations.cancellation,
        sla_confirmed: data.confirmations.sla,
        full_data: data,
      })
      .select()
      .single();
